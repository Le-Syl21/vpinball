...
mkdir -p "external/macos-arm64/${BUILD_TYPE}"
cd "external/macos-arm64/${BUILD_TYPE}"
...
cp -a SDL3/SDL_ttf/build/libSDL3_ttf.{dylib,*.dylib} ../../../third-party/runtime-libs/macos-arm64
cp -r SDL3/SDL_ttf/include/SDL3_ttf ../../../third-party/include/

cp -a freeimage/freeimage/build/libfreeimage.{dylib,*.dylib} ../../../third-party/runtime-libs/macos-arm64
...
cp -a libdof/libdof/third-party/runtime-libs/macos/arm64/libusb-1*.dylib ../../../third-party/runtime-libs/macos-arm64
cp -a libdof/libdof/third-party/runtime-libs/macos/arm64/libhidapi.{dylib,*.dylib} ../../../third-party/runtime-libs/macos-arm64
cp -a libdof/libdof/third-party/runtime-libs/macos/arm64/libftdi1*.dylib ../../../third-party/runtime-libs/macos-arm64

for LIB in libavcodec libavdevice libavfilter libavformat libavutil libswresample libswscale; do
   cp -a ffmpeg/ffmpeg/${LIB}/${LIB}.{dylib,*.dylib} ../../../third-party/runtime-libs/macos-arm64
